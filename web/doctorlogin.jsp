<%-- 
    ...
    Created on : Jan 4, 2022, 12:25:17 PM
    Author     : JAVA
--%>
	...
	<div class="login-html" style="background: #32346c">
		...
		<div class="login-form">
			<div class="sign-in-htm">
                                                <form action="doclogincheck.jsp" method="post">

				<div class="group">
					<label for="user" class="label">Username</label>
                                        <input id="user" type="text" name="dname" class="input">
				</div>
				<div class="group">
			...
			<div class="sign-up-htm">
				...
				<div class="group">
					<label for="user" class="label">Doctor Name</label>
                            ...
                            <div class="group">
					<label for="pass" class="label">Hospital Name</label>
					<input id="pass" type="text" class="input" name="hsptname">
				</div>
                            <div class="group">
					<label for="pass" class="label">Specialization </label>
					<input id="pass" type="text" class="input" name="specialization">
				</div>
                            <div class="group">
