<%-- 
    Document   : consultdoc
    Created on : Jan 5, 2022, 10:54:16 AM
    Author     : JAVA
--%>
...
.me a:hover {
  ...
  transition: all easy 0.3s;
		  ...
		  PreparedStatement ps = Database.con().prepareStatement(query);
                ...
                <tr>
                   ...
                   <th style="text-align: center;font-size: 15px;color:black;font-family: auto" > Doctor Name</th>
                                    <th style="text-align: center;font-size: 15px;color:black;font-family: auto" >Hospital Name</th> 

                   <th style="text-align: center;font-size: 15px;color:black;font-family: auto" >Specialization</th>
              ...
              <th style="text-align: center;font-size: 15px;color:black;font-family: auto" >Consult Doctor</th>
                ...
                <% 
                    ...
                    {%>
                      ...
                      <tr>
                          ...
                          <td style="text-align: center;font-size: 15px;color:black;font-family: auto"><%=rs1.getString("hsptname")%></td>
                          <td style="text-align: center;font-size: 15px;color:black;font-family: auto"><%=rs1.getString("specialization")%></td>
   ...
   <td style="text-align: center;font-family: times "><a href= "consult.jsp?dname=<%=rs1.getString("dname")%>">Ask Doctor</a></td>
