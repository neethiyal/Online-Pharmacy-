<%-- 
    Document   : index
    Created on : Jan 3, 2022, 5:25:25 PM
    Author     : JAVA
--%>
...
.btn1{
background: transparent linear-gradient(90deg, #3cf3e2 0%, #3cf3e2 100%) 0% 0% no-repeat padding-box;
color:#fff;
font-weight:600;
}
...
.logo{
background: transparent linear-gradient(90deg, #167ce9 0%, #0fa1ea 100%) 0% 0% no-repeat padding-box;
}
}
/*NAVIGATION*/
.topnav {
...
<img src="img/1.jpg" style="margin:0 10px;float:left;" alt="LEVIOOSA MARKETING.">
</div>

<div class="topnav" id="myTopnav">
<a href="#" class="active">HOME</a>
<a href="pharmacistlogin.jsp" class="active" style="margin-left: -5px;">PHARMACIST </a>
<a href="customerlogin.jsp">CUSTOMER</a>
<a href="doctorlogin.jsp">DOCTORS</a>
...
<div class="container">
<section>
<em>WELCOME TO ONLINE PHARMACY</em>
<h1>Take the world's best quality Products</h1>
<a href="customerlogin.jsp" class="btn1"> Shop Now</a>
</section>
</div>

<!--SECTION2-->
<section class="section2" style="background:#3cf3e2">
<div class="cards">
<div class="card">
